...
@Component({
    tag: 'page-beaver-cage-command-chron',
    styleUrl: 'page-beaver-cage-command-chron.css'
})
export class PageBeaverCageCommandChron {
    ...
    componentWillLoad() {
        if (isLocal()) {
            console.log('> PageBeaverCageCommandChron.componentWillLoad');
        }
