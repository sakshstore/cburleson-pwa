...
export class Page7QuintessentialBrushesForZbrushBeginners {
    ...
    async componentWillLoad() {
        if (debug) {
            console.log('> Page7QuintessentialBrushesForZbrushBeginners.componentWillLoad');
        }
        ...
        return [
            ...
            <ion-content class="ion-padding">
                ...
                <ion-card>
                    <ion-item>
                        <ion-thumbnail slot="start">
                            <img src="https://codyburleson.com/wp-content/uploads/2018/07/zbrush-brush-standard.jpg" alt="" />
                        </ion-thumbnail>
                ...
                <ion-card>
                    <ion-item>
                        <ion-thumbnail slot="start">
                            <img src="https://codyburleson.com/wp-content/uploads/2018/07/zbrush-brush-smooth.jpg" alt="" />
                        </ion-thumbnail>
                ...
                <ion-card>
                    <ion-item>
                        <ion-thumbnail slot="start">
                            <img src="https://codyburleson.com/wp-content/uploads/2018/07/zbrush-brush-move.jpg" alt="" />
                        </ion-thumbnail>
                ...
                <ion-card>
                    <ion-item>
                        <ion-thumbnail slot="start">
                            <img src="https://codyburleson.com/wp-content/uploads/2018/07/zbrush-brush-clay.jpg" alt="" />
                        </ion-thumbnail>
                ...
                <ion-card>
                    <ion-item>
                        <ion-thumbnail slot="start">
                            <img src="https://codyburleson.com/wp-content/uploads/2018/07/zbrush-brush-claybuildup.jpg" alt="" />
                        </ion-thumbnail>
                ...
                <ion-card>
                    <ion-item>
                        <ion-thumbnail slot="start">
                            <img src="https://codyburleson.com/wp-content/uploads/2018/07/zbrush-brush-trimdynamic.jpg" alt="" />
                        </ion-thumbnail>
                ...
                <ion-card>
                    <ion-item>
                        <ion-thumbnail slot="start">
                            <img src="https://codyburleson.com/wp-content/uploads/2018/07/zbrush-brush-damstd.jpg" alt="" />
                        </ion-thumbnail>
