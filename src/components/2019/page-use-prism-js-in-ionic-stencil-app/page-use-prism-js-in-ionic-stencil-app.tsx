                ...
                <ion-grid>
                    <ion-row>
                        <ion-col size-xs="12" size-sm="12" size-md="8" size-lg="8" size-xl="7">
                            ...
                            <pre><code class="language-ts">{`import { Component, h } from '@stencil/core';
import { isLocal, SITENAME } from '../../../helpers/utils';
import Prism from "prismjs"
...
// ...`}</code></pre>
                            ...
                            <pre><code class="language-ts">{`componentDidLoad() {
    setTimeout(() => Prism.highlightAll(), 0)
}`}</code></pre>
...
WORDPRESS_DB_PASSWORD: ChangeMeIfYouWant\`}</code></pre>`}</code></pre>
                            ...
                            <pre><code class="language-ts">{`// Additional stuff...
...
import 'prismjs/components/prism-scss';`}</code></pre>
