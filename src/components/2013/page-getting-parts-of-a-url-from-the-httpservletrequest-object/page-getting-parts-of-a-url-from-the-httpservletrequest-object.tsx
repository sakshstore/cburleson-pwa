                ...
                <ion-grid>
                    <ion-row>
                        <ion-col size-xs="12" size-sm="12" size-md="8" size-lg="8" size-xl="7">
                            ...
                            <deckgo-highlight-code language="java"><code slot="code">{CODE_1}</code></deckgo-highlight-code>
                            ...
                            <deckgo-highlight-code language="bash"><code slot="code">{CODE_2}</code></deckgo-highlight-code>
